# API Contracts — Unified BMS — Building Energy Intelligence Platform

These contracts are the single source of truth between frontend and backend.
Any real external API (Smart Buildings habitat systems, DISCOM, etc.) can be adapted to these shapes.
